...
struct PartnerBook {
    let partnerArray = [
        ...
        "Wat is het naarste dat iemand het afgelopen jaar tegen je gezegd heeft?",
        ...
        "Wat heb je altijd graag willen kunnen maar kan je niet?",
        ...
        "Wie beïnvloed jouw leven op dit moment het meest?",
        "Wie verdient volgens jou de titel 'loser van het jaar'?",
        "Wie verdient volgens jou een nobelprijs?",
        "Wat houd je op dit moment het meeste bezig in je leven?",
        "Vraag je medespelers te vertellen wat jou op dit moment het meeste bezig houd in het leven.",
        ...
        "Wanneer heb je je voor het laatst (heel erg) onzeker gevoeld? Omschrijf de situatie.",
        ...
        "Welke eigenschap van een van de andere spelers zou je graag zelf willen hebben?",
        ...
        "Hoe denk je dat de speler die tegenover je zit jou als persoon ziet? Heb je gelijk?",
        ...
        "Vraag aan de speler links van je of hij/zij jou avontuurlijk vindt en waarom wel of niet.",
        "Vraag aan de persoon rechts van je wat hij/zij jouw unieke kwaliteit of talent vindt.",
        "Waar gruwel jij van?",
        "Welke persoon doet jou wat? En wat is dat?",
        "Wie kan je niet uit staan? Waarom niet?",
        ...
        "Vraag de speler tegenover je wat hij/zij graag van jou zou willen weten.",
        ...
        "Hoe hecht en warm is je familie? Denk je dat jouw jeugd gelukkiger was dan die van anderen?",
        "Hoe is je relatie met je moeder?",
